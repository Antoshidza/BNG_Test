...
namespace Tweens {
  public sealed class RectTween : Tween<Transform, Rect> {
    ...
    internal sealed override Rect Lerp([Bridge.Ref] Rect from, [Bridge.Ref] Rect to, float time) {
    ...
    internal sealed override void Apply(Transform component, [Bridge.Ref] Rect value) { }
  }
}