...
public static class HexMath
{
    ...
    public static HexCoord Neighbor([Bridge.Ref] HexCoord coord, HexDirection direction)
    {
        return coord + Directions[(int)direction];
    }

    public static int Distance([Bridge.Ref] HexCoord a, [Bridge.Ref] HexCoord b)
    {
    ...
    public static Vector2Int ToOffset([Bridge.Ref] HexCoord coord)
    {
    ...
    public static HexCoord FromOffset([Bridge.Ref] Vector2Int offset)
    {
    ...
    public static void FillRange([Bridge.Ref] HexCoord center, int range, List<HexCoord> results)
    {
        if (results == null)
    ...
    public static void FillRing([Bridge.Ref] HexCoord center, int radius, List<HexCoord> results)
    {
        if (results == null)
            throw new ArgumentNullException(nameof(results));
